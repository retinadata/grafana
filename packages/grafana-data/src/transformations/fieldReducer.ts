...
export const fieldReducers = new Registry<FieldReducerInfo>(() => [
  {
    ...
    name: t`Last *`,
    description: t`Last non-null value`,
    standard: true,
    aliasIds: ['current'],
  ...
  },
  {
    id: ReducerID.last,
    name: t`Last`,
    description: t`Last value`,
    standard: true,
    reduce: calculateLast,
  },
  { id: ReducerID.first, name: t`First`, description: t`First Value`, standard: true, reduce: calculateFirst },
  {
    id: ReducerID.firstNotNull,
    name: t`First`,
    description: t`First non-null value`,
    standard: true,
    reduce: calculateFirstNotNull,
  },
  { id: ReducerID.min, name: t`Min`, description: t`Minimum Value`, standard: true },
  { id: ReducerID.max, name: t`Max`, description: t`Maximum Value`, standard: true },
  { id: ReducerID.mean, name: t`Mean`, description: t`Average Value`, standard: true, aliasIds: ['avg'] },
  {
    id: ReducerID.sum,
    name: t`Total`,
    description: t`The sum of all values`,
    emptyInputResult: 0,
    standard: true,
    aliasIds: ['total'],
  },
  {
    id: ReducerID.count,
    name: t`Count`,
    description: t`Number of values in response`,
    emptyInputResult: 0,
    standard: true,
  },
  {
    id: ReducerID.range,
    name: t`Range`,
    description: t`Difference between minimum and maximum values`,
    standard: true,
  },
  {
    id: ReducerID.delta,
    name: 'Delta',
    description: t`Cumulative change in value`,
    standard: true,
  },
  {
    id: ReducerID.step,
    name: t`Step`,
    description: t`Minimum interval between values`,
    standard: true,
  },
  {
    id: ReducerID.diff,
    name: t`Difference`,
    description: t`Difference between first and last values`,
    standard: true,
  },
  {
    id: ReducerID.logmin,
  ...
  },
  {
    ...
    name: t`Difference percent`,
    description: t`Percentage difference between first and last values`,
    standard: true,
  },
  {
    id: ReducerID.allValues,
    name: t`All values`,
    description: t`Returns an array with all values`,
    standard: false,
