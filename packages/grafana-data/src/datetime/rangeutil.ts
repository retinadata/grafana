...
const hiddenRangeOptions: TimeOption[] = [
  { from: 'now', to: 'now+1m', display: t`Next minute` },
  { from: 'now', to: 'now+5m', display: t`Next 5 minutes` },
  { from: 'now', to: 'now+15m', display: t`Next 15 minutes` },
  { from: 'now', to: 'now+30m', display: t`Next 30 minutes` },
  { from: 'now', to: 'now+1h', display: t`Next hour` },
  { from: 'now', to: 'now+3h', display: t`Next 3 hours` },
  { from: 'now', to: 'now+6h', display: t`Next 6 hours` },
  { from: 'now', to: 'now+12h', display: t`Next 12 hours` },
  { from: 'now', to: 'now+24h', display: t`Next 24 hours` },
  { from: 'now', to: 'now+2d', display: t`Next 2 days` },
  { from: 'now', to: 'now+7d', display: t`Next 7 days` },
  { from: 'now', to: 'now+30d', display: t`Next 30 days` },
  { from: 'now', to: 'now+90d', display: t`Next 90 days` },
  { from: 'now', to: 'now+6M', display: t`Next 6 months` },
  { from: 'now', to: 'now+1y', display: t`Next year` },
  { from: 'now', to: 'now+2y', display: t`Next 2 years` },
  { from: 'now', to: 'now+5y', display: t`Next 5 years` },
];
